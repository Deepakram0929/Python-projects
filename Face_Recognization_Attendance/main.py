...
# Load known faces
deepus_image = face_recognition.load_image_file("faces/deepu.jpg")  # Load image file for Harsh
deepu_encoding = face_recognition.face_encodings(deepus_image)[0]  # Encode the face of Harsh
...
known_face_encodings = [deepu_encoding, sundaram_encoding]  # List of known face encodings
known_face_names = ["Deepu", "Kumar Sundaram"]  # List of known face names
